...
<form class="col-4 p-3 m-auto" method="POST">
        <h5 class="text-center text-secondary">Modificar Vehiculo</h3>
        <input type="hidden" name="id" value="<?=$_GET["id"]?>">
        <?php 
        include "controlador/modificar_vehiculo.php";
...
<div class="mb-3">
  ...
  <button type="submit" class="btn btn-primary" name="btnregistrar" value="ok">Modificar Vehiculo</button>
</form>
</body>
</html>